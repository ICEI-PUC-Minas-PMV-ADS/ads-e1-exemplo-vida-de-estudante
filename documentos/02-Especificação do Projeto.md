...
<span style="color:red">Pré-requisitos: <a href="https://github.com/ICEI-PUC-Minas-PMV-ADS/ads-e1-exemplo-vida-de-estudante/blob/main/documentos/01-Documentação%20de%20Contexto.md"> Documentação de Contexto</a></span>
...
<tbody>
<tr>
<th colspan="2">Perfil Luiz Campos </th>
</tr>
<tr>
<td width="150px"><b>Descrição</b></td>
<td width="600px">
Idade: 22 anos<br>
Ocupação: Estudante de Sistemas de Informação (último período) e estagiário no setor de desenvolvimento de softwares em um banco digital.<br>
Localização: Belo Horizonte, MG<br>
Estado Civil: Solteiro<br>
Interesses/Hobbies: Jogar videogame, ouvir música, tecnologia e inovação.
</td>
</tr>
<tr>
<td><b>Necessidades</b></td>
<td>
Luiz está cursando o último período de Sistemas de Informação, e atualmente estagiando no setor de desenvolvimento de softwares em um banco digital. Ele é um entusiasta da tecnologia e inovação, utiliza aplicativos como Instagram, Twitter, LinkedIn e Pinterest e mora em Belo Horizonte (MG). Luiz tem o desejo de fazer parte de uma rede social descontraída de estudantes e está disposto a auxiliar calouros com dificuldades nos estudos, baseado em suas próprias experiências. Ele acredita que a tecnologia pode melhorar a sociedade, mas sente dificuldades em conhecer pessoas com interesses em comum. Além disso, ele enfrenta o dilema de encontrar uma solução para os livros que comprou e já leu, os quais ocupam muito espaço em sua estante. Luiz está prestes a se formar, mas ainda precisa cumprir alguns créditos extras da faculdade e adquirir mais conhecimento para atender às demandas do mercado em sua área de formação.
</td>
</tr>
</tbody>
</table>
